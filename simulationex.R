...
gs.sim=function(n,x,params) {
  g<-rnorm(n,params[36,site]+params[37,site]*x,params[38,site])
}
...
site=1
gssim<-rep.int(0,54)
gssim<-gs.sim(54,GOES$size,params)
par(mfrow=c(1,1))
plot(GOES$size,GOES$sizeNext,main="Extreme shrinkage growth",xlab="Size t",ylab="Size t+1")
points(GOES$size,gssim,pch=18,col="red")
legend("bottomright", legend = c("observed","simulated"), col = c("black","red"), pch =c(1,18), xjust = 1, bg = "white")

ggsim<-list(vector("numeric",135),vector("numeric",26),vector("numeric",55),vector("numeric",67),vector("numeric",64),vector("numeric",84),vector("numeric",109),vector("numeric",68),vector("numeric",36),vector("numeric",103))
for (i in 1:10){
  x<-subset(GONGS,GONGS$utrans==levels(GONGS$utrans)[i])
  ggx<-x$size
  site=i
  n=length(ggx)
  ggsim[[i]]<-gg.sim(n,ggx,params)
}
par(mfrow=c(2,2))
for (i in 1:10){
  x<-subset(GONGS,GONGS$utrans==levels(GONGS$utrans)[i])
  plot(x$size,x$sizeNext,main=levels(x$utrans)[i],xlim=c(-2,10),ylim=c(-2,10),xlab="Size t",ylab="Size t+1")
  points(x$size,ggsim[[i]],col="red",pch=18)
}
legend("bottomright", legend = c("observed","simulated"), col = c("black","red"), pch =c(1,18), xjust = 1, bg = "white")
...
for (i in 1:10){
  x<-subset(GONGS,GONGS$utrans==levels(GONGS$utrans)[i])
  points(x$size,ggsim[[i]],col="black",pch=18)
}
points(GOES$size,gssim,pch=18,col="purple")
points(fissonly$size,fissonly$sizeNext,pch=18,col="red")
...
Pessim<-rbinom(n=length(growthonly$size),size=1,prob=p.es.x(growthonly$size,params))
plot(growthonly$size,growthonly$PES)
points(growthonly$size,Pessim,pch=18,col="red")
####Clone number
...
points(y,gs.sim(300,y,params),col="purple",pch=18,cex=0.7)

legend("bottomright", legend = c("fission","fusion","extreme shrinkage"), col = c("red","green","purple"), pch =18, xjust = 1, bg = "white")
...
for (i in 1:10){
  site=i
  points(y,gg.sim(300,y,params),pch=18,cex=0.7)
}
points(y,ig.sim(300,y,params),col="red",pch=18,cex=0.7)
points(y,ug.sim(300,y,params),col="green",pch=18,cex=0.7)
points(y,gs.sim(300,y,params),col="purple",pch=18,cex=0.7)

legend("bottomright", legend = c("stasis","fission","fusion","extreme shrinkage"), col = c("black","red","green","purple"), pch =18, xjust = 1, bg = "white")
...
for (i in 1:10){
  ...
  PGsim[start:end]<-gg.sim(300,y,params)*rbinom(n=length(y),size=1,prob=(1-p.fiss.x(y,params=params) - p.fuse.x(y,params=params) + p.fiss.x(y,params=params)*p.fuse.x(y,params=params))*(1-p.es.x(y,params=params)))
}
PGsim<-as.data.frame(PGsim)
PGsim$yval<-rep.int(y,10)
PGsim<-subset(PGsim,PGsim!=0)

PSsim<-gs.sim(300,y,params)*rbinom(n=length(y),size=1,prob=(1-p.fiss.x(y,params=params) - p.fuse.x(y,params=params) + p.fiss.x(y,params=params)*p.fuse.x(y,params=params)*p.es.x(y,params=params)))
PSsim<-as.data.frame(PSsim)
PSsim$yval<-y
PSsim<-subset(PSsim,PSsim!=0)

plot(0,0,xlim=c(-2,10),ylim=c(-2,10),type="n",main="Stasis Growth",xlab="Size t",ylab="Size t+1")
points(PGsim$yval,PGsim$PGsim,col="black",pch=18,cex=0.5)
points(PSsim$yval,PSsim$PSsim,col="purple",pch=18,cex=0.7)
...
points(PIsim$yval,PIsim$PIsim,col="red",pch=18,cex=0.7)
points(PGsim$yval,PGsim$PGsim,col="black",pch=18,cex=0.7)
points(PUsim$yval,PUsim$PUsim,col="green",pch=18,cex=0.7)
points(PSsim$yval,PSsim$PSsim,col="purple",pch=18,cex=0.7)
legend("bottomright", legend =c("growth","fusion","fission","extreme shrinkage") , col = c("black","green","red","purple"), pch =18, xjust = 1, bg = "white")
...
par(mfrow=c(1,1))
hist(GONGS$sizeNext,freq=F,main="Size t+1 Stasis growth",xlab="Size t+1",xlim=c(-2,10),ylim=c(0,0.5))
...
par(mfrow=c(1,1))
hist(GOES$sizeNext,freq=F,main="Size t+1 Extreme Shrinkage growth",xlab="Size t+1",xlim=c(-2,10),ylim=c(0,0.5))
hist(PSsim$PSsim,freq=F,add=T,col=rainbow(1,alpha=0.25))
legend("right", legend = c("observed","simulated"), col = c("black","red"), pch =15, xjust = 1, bg = "white")


hist(fissonly$sizeNext,freq=F,main="Size t+1 Stasis growth",xlab="Size t+1",xlim=c(-2,10),ylim=c(0,0.5))
hist(PIsim$PIsim,freq=F,add=T,col=rainbow(1,alpha=0.25))
legend("right", legend = c("observed","simulated"), col = c("black","red"), pch =15, xjust = 1, bg = "white")


hist(fuseonly$sizeNext,freq=F,main="Size t+1 Stasis growth",xlab="Size t+1",xlim=c(-2,10),ylim=c(0,0.5))
